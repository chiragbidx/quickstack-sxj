...
const faqs = [
    {
        question: 'Do I need coding or design experience to use Panda?',
    ...
    {
        question: 'What is Panda and how does it help developers and designers?',
        answer: 'Panda provides ready-to-use, customizable UI components and templates, saving time for developers and designers.',
    },
    {
        question: 'Can I use Panda components in my existing project?',
    ...
    {
        question: 'Does Panda support team collaboration?',
        answer: "There's no clear documentation on built-in collaboration features. Check their support for team options.",
    },
    {
        question: 'Can I try Panda before purchasing a plan?',
        answer: 'Yes, you can try Panda with full access to features.',
    },
];
...
const plans = [
    {
        icon: `
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket size-35" aria-hidden="true">
    ...
    {
        icon: `
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-zap size-35" aria-hidden="true">
    ...
    {
        icon: `
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-crown size-35" aria-hidden="true">
